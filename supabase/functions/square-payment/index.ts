  ...
  try {
    ...
    if (action === 'create_payment') {
      ...
      const orderRecord: Record<string, any> = {
        ...
        billing_address1: orderData.customerInfo?.billingAddress?.address1?.trim() || null,
        billing_address2: orderData.customerInfo?.billingAddress?.address2?.trim() || null,
        billing_city: orderData.customerInfo?.billingAddress?.city?.trim() || null,
        billing_state: orderData.customerInfo?.billingAddress?.state?.trim() || null,
        billing_zipcode: orderData.customerInfo?.billingAddress?.zipcode?.trim() || null,
